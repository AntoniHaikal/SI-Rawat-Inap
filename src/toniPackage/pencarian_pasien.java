...
import sistem_rawat_inap_puskesmas.*;
 ...
 * @author root
 */
public class pencarian_pasien extends javax.swing.JInternalFrame {
    ...
    public pencarian_pasien(JDesktopPane DP) {
        initComponents();
        this.DP = DP;
        SettingTableModel();
        clear();
    ...
    private void clear(){
     ...
     private void ambil(){
            ...
            String regid = tblcari.getValueAt(row, 0).toString();
            String medrec = tblcari.getValueAt(row, 1).toString();
            String nama = tblcari.getValueAt(row, 2).toString();
            
            FormAsuhanKebidanan fah = new FormAsuhanKebidanan(DP,regid,medrec,nama);
            DP.removeAll();
            DP.repaint();
            DP.add(fah);
            fah.show();
    ...
    private void initComponents() {
        ...
        jLayeredPane2.add(btn_batal);
        btn_batal.setBounds(580, 70, 110, 23);
        jLayeredPane2.add(dc_awal);
        dc_awal.setBounds(121, 60, 130, 30);
        jLayeredPane2.add(dc_akhir);
