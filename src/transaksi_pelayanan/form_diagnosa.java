...
public class form_diagnosa extends javax.swing.JInternalFrame {
    ...
    private void tampil() {
        try {
            ...
            String query = "select * from diagnosa";
    ...
    private void SettingTableModel() {
        TableModels = TableViews.getDefaultTableModel(new String[]{
                    ...
                    "Nama Diagnosa Utama",
                    "Diagnosa Keluar",
                    "Nama Diagnosa Keluar",
                    "Petugas",
                    "Tanggal Buat"},
                null, new int[]{4, 6, 8}, null);
        tblcari.setModel(TableModels);
        TableViews.table(tblcari, new int[]{100, 100, 150, 150, 150, 100, 150, 150, 150, 100, 150, 150});
       ...
       TableModels = TableViews.getDefaultTableModel(new String[]{
        ...
        try {
            ...
            if (cb_tanggal.isSelected() == false) {
                try {
                    String query = "SELECT * from diagnosa WHERE "
    ...
    private void updatediagnosa() {
        ...
        String diagnosaawal = tblcari.getValueAt(row, 4).toString();
        String diagnosautama = tblcari.getValueAt(row, 6).toString();
        String diagnosakeluar = tblcari.getValueAt(row, 8).toString();
        try {
            TableModels.getDataVector().removeAllElements();
    ...
    private void initComponents() {
        ...
        btn_cari.setBounds(580, 70, 100, 23);
